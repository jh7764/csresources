...
import { MdDeveloperBoard, MdOutlineLocalLibrary, MdExpandMore } from "react-icons/md";
import './Navbar.css'
...
const Navbar = () => {
  ...
  return (
    <Menu>
      <a className="menu-item resources-toggle" onClick={setIsOpen(prev => !prev)}>
        Resources
        <MdExpandMore className = {`menu-chevron ${isOpen ? 'open' : ''}`} />
      </a>
